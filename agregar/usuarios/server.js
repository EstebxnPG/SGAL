...
app.post('/usuario', (req, res) => {
    ...
    const sql = "INSERT INTO usuario (tipo_usuario, tipo_documento, num_documento, nombre, correo, num_telefono, estado, contrasena) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    db.query(sql, values, (err, result) => {
        ...
        res.status(201).json({ id: result.insertId, tipo_usuario, tipo_documento, num_documento, nombre, correo, num_telefono, estado, contrasena});
    });
});
